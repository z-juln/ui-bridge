# 彻底移除 macos-ui-bridge 旧名称 - 任务包索引
...
| Field | Value |
| --- | --- |
| Task ID | `2026-07-14-macos-ui-bridge-627e70e9` |
| Budget | `standard` |
| Preset | `none` |
| Module | `n/a` |
| Long-running | `yes` |
...
| Command Shape | harness new-task --budget standard --locale zh-CN --title '彻底移除 macos-ui-bridge 旧名称' --long-running . |
| Budget | standard |
